...
public class SampleDAOImpl extends BaseDAOImpl implements SampleDAO {
    ...
    public void updateData(Sample sample) throws LIMSRuntimeException {
        LogEvent.logError("SampleDAOImpl", "updateData()", "Inside update data method");
        ...
        Timestamp collectionDate = sample.getCollectionDate() == null ? new Timestamp(System.currentTimeMillis()) : oldData.getCollectionDate();
