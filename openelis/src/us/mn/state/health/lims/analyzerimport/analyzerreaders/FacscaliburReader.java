...
public class FacscaliburReader extends AnalyzerLineInserter {
	...
	private static final int Control_Low_Beads_uL = index++;
	private static final int Control_Medium_Beads_uL = index++;
	private static final int Control_High_Beads_uL = index++;
	...
	private String getCorrectedMonth(String month) {
		if( month.endsWith(".") || month.equals("mars") || month.equals("mai") || month.equals("juin") || month.equals("ao�t") ){
			return month;
		}
