...
public class Organization extends EnumValueItemImpl implements SimpleBaseEntity<String>{
	...
	//bugzilla 2069
	private String concatOrganizationLocalAbbreviationName;
	...
	public void setConcatOrganizationLocalAbbreviationName(String concatOrgIdName) {
		this.concatOrganizationLocalAbbreviationName = concatOrganizationLocalAbbreviationName;
	}
