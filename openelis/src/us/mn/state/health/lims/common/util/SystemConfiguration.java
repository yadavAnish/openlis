...
//bugzilla 1742
	...
	public Locale getDefaultLocale() {
		String localeString = ConfigurationProperties.getInstance().getPropertyValue(Property.defaultLangLocale);
   ...
   //bugzilla 1387 rename this method so more generic
	...
	public Locale getDateLocale() {
		String localeString = ConfigurationProperties.getInstance().getPropertyValue(Property.defaultDateLocale);
