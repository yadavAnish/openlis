...
public class AnalysisHistoryService extends HistoryService {
	...
	private void setUpForAnalysis(Analysis analysis) {
		if ( !analysis.getStatusId().equals(StatusOfSampleUtil.getStatusID(AnalysisStatus.ReferredIn)) && analysis.getTest() != null) {
			...
			newValueMap.put(STATUS_ATTRIBUTE, StatusOfSampleUtil.getStatusNameFromId(analysis.getStatusId()));

			identifier = analysis.getTest().getTestName() + " (" + analysis.getAnalysisType() + ")";
		}else{
