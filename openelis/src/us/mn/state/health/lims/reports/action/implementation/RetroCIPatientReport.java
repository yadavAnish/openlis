...
public abstract class RetroCIPatientReport extends RetroCIReport {
	...
	static{
		...
		READY_FOR_REPORT_STATUS_IDS.add(Integer.parseInt(StatusOfSampleUtil.getStatusID(OrderStatus.Finished)));
		READY_FOR_REPORT_STATUS_IDS.add(Integer.parseInt(StatusOfSampleUtil.getStatusID(OrderStatus.Started)));

		ANALYSIS_FINALIZED_STATUS_ID = StatusOfSampleUtil.getStatusID(AnalysisStatus.Finalized);
	}
