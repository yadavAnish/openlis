    ...
    private boolean duplicateMessageOrganizationExists(
        ...
        try {
            ...
            if (messageOrganization.getIsActive().equalsIgnoreCase(IActionConstants.YES)) {
                ...
                query.setParameter("param3", Integer.parseInt(messageOrganizationId));
            ...
            //bugzilla 2154
            LogEvent.logErrorStack("MessageOrganizationDAOImpl", "duplicateMessageOrganizationExists()", e);
            throw new LIMSRuntimeException(
