...
function changeSourceColor(source){
	if(source != null && source.indexOf('ER') !== -1){
...
function getColumnsForTodayOrder(alwaysValidate) {
    if (alwaysValidate) {
        return [
            {id:"accessionNumber", name:jQuery("#translatedColumnNames").attr("data-accessionNumber"), field:"accessionNumber", sortable:true, index:0, editor:Slick.Editors.Text, minWidth:145},
            {id:"stNumber", name:jQuery("#translatedColumnNames").attr("data-patientID"), field:"stNumber", sortable:true, editor:Slick.Editors.Text, index:1, minWidth:115},
            {id:"name", name:jQuery("#translatedColumnNames").attr("data-patientName"), field:"name", sortable:true, index:2, editor:Slick.Editors.Text, minWidth:155},
			{id:"source", name:jQuery("#translatedColumnNames").attr("data-source"), field:"source", sortable:true, formatter:formatter, index:3, editor:Slick.Editors.Text, minWidth:140},
			{id:"orderDate", name:jQuery("#translatedColumnNames").attr("data-orderDate"), field:"orderDate", sortable:false, index:4, editor:Slick.Editors.Text, minWidth:100},
            {id:"receivedDate", name:jQuery("#translatedColumnNames").attr("data-receivedDate"), field:"orderEnteredDate", sortable:false, index:5, editor:Slick.Editors.Text, minWidth:100},
            {id:"collectionDate", name:jQuery("#translatedColumnNames").attr("data-sampleCollectionDate"), field:"sampleCollectionDisplayDate", sortable: true, searchable:true, index: 6, minWidth: 100},
            {id:"pendingTestCount", name:jQuery("#translatedColumnNames").attr("data-pendingTests"), field:"pendingTestCount", sortable:true, editor:Slick.Editors.Text, index:7, searchable:false, minWidth:70},
            {id:"pendingValidationCount", name:jQuery("#translatedColumnNames").attr("data-pendingValidation"), field:"pendingValidationCount", sortable:true, editor:Slick.Editors.Text, index:8, searchable:true, minWidth:90},
            {id:"totalTestCount", name:jQuery("#translatedColumnNames").attr("data-total"), field:"totalTestCount", sortable:true, editor:Slick.Editors.Text, index:8, searchable:false, minWidth:35},
            ...
            {id:"completedDate", name:jQuery("#translatedColumnNames").attr("data-completedDate"), field:"completedDate", sortable: false, index: 10, minWidth: 100},
            {id:"link", name:jQuery("#translatedColumnNames").attr("data-action"), field:"link", cssClass:"cell-title", formatter:formatter, index:11, editor:Slick.Editors.Text, searchable:false, minWidth:95},
        ...
        return [
            ...
            {id:"stNumber", name:jQuery("#translatedColumnNames").attr("data-patientID"), field:"stNumber", sortable:true, editor:Slick.Editors.Text, index:1, minWidth:140},
            {id:"name", name:jQuery("#translatedColumnNames").attr("data-patientName"), field:"name", sortable:true, index:2, editor:Slick.Editors.Text, minWidth:180},
			{id:"source", name:jQuery("#translatedColumnNames").attr("data-source"), field:"source", sortable:true, formatter:formatter, index:3, editor:Slick.Editors.Text, minWidth:140},
			{id:"orderDate", name:jQuery("#translatedColumnNames").attr("data-orderDate"), field:"orderDate", sortable:false, index:4, editor:Slick.Editors.Text, minWidth:100},
            {id:"receivedDate", name:jQuery("#translatedColumnNames").attr("data-receivedDate"), field:"orderEnteredDate", sortable:false, index:5, editor:Slick.Editors.Text, minWidth:100},
            {id:"collectionDate", name:jQuery("#translatedColumnNames").attr("data-sampleCollectionDate"), field:"sampleCollectionDisplayDate", sortable: false, index: 6, minWidth: 100},
            {id:"pendingTestCount", name:jQuery("#translatedColumnNames").attr("data-pendingTests"), field:"pendingTestCount", sortable:true, editor:Slick.Editors.Text, index:7, searchable:false, minWidth:80},
...
function getColumnsForBacklogOrder(alwaysValidate) {
    if (alwaysValidate) {
        return [
			...
			{id:"source", name:jQuery("#translatedColumnNames").attr("data-source"), field:"source", sortable:true, formatter:formatter, index:4, editor:Slick.Editors.Text, minWidth:160},
            ...
            {id:"pendingTestCount", name:jQuery("#translatedColumnNames").attr("data-pendingTests"), field:"pendingTestCount", sortable:true, editor:Slick.Editors.Text, index:8, minWidth:130},
            {id:"pendingValidationCount", name:jQuery("#translatedColumnNames").attr("data-pendingValidation"), field:"pendingValidationCount", sortable:true, editor:Slick.Editors.Text, index:8, searchable:false, minWidth:100},
            ...
            {id:"link", name:jQuery("#translatedColumnNames").attr("data-action"), field:"link", cssClass:"cell-title", formatter:formatter, index:10, editor:Slick.Editors.Text, searchable:false, minWidth:120},
        ...
        return [
            ...
            {id:"name", name:jQuery("#translatedColumnNames").attr("data-patientName"), field:"name", sortable:true, index:2, editor:Slick.Editors.Text, minWidth:190},
			{id:"source", name:jQuery("#translatedColumnNames").attr("data-source"), field:"source", sortable:true, formatter:formatter, index:3, editor:Slick.Editors.Text, minWidth:160},
			{id:"orderDate", name:jQuery("#translatedColumnNames").attr("data-orderDate"), field:"orderDate", sortable:false, index:4, editor:Slick.Editors.Text, minWidth:100},
            ...
            {id:"collectionDate", name:jQuery("#translatedColumnNames").attr("data-sampleCollectionDate"), field:"sampleCollectionDisplayDate", sortable: true, index: 6, searchable:false, minWidth: 120},
...
function getColumnsForSampleNotCollected() {
        return [
            ...
            {id:"name", name:jQuery("#translatedColumnNames").attr("data-patientName"), field:"name",cssClass:"cell-title", sortable:true, index:1, editor:Slick.Editors.Text, minWidth:160},
			{id:"source", name:jQuery("#translatedColumnNames").attr("data-source"), field:"source", sortable:true, formatter:formatter, index:2, editor:Slick.Editors.Text, minWidth:160},
