    ...
    <table width="100%">
        ...
        <tr>
            ...
            <app:text name="<%=formName%>"
                ...
                onchange="iarv.checkReceivedTime(true);"
                styleClass="text"
        ...
        <tr>
            ...
            <app:text name="<%=formName%>"
                    ...
                    onchange="iarv.checkInterviewTime(true);"
                    styleClass="text"
                    styleId="iarv.interviewTime" maxlength="10"/>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <app:text name="<%=formName%>"
                    property="receivedTimeForDisplay"
                    styleClass="text"
                    styleId="farv.receivedTimeForDisplay" maxlength="10"                    
                    onchange="farv.checkReceivedTime(true);" />
        ...
        <tr>
            ...
            <app:text name="<%=formName%>"
                    property="interviewTime"                    
                    onchange="farv.checkInterviewTime(true);"
                    styleClass="text"
                    styleId="farv.interviewTime" maxlength="10"/>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <app:text name="<%=formName%>"
                    property="receivedTimeForDisplay"
                    styleClass="text"
                    styleId="rtn.receivedTimeForDisplay" maxlength="10"                    
                    onchange="rtn.checkReceivedTime(true);" />
        ...
        <tr>
            ...
            <app:text name="<%=formName%>"
                    property="interviewTime"
                    styleClass="text"
                    styleId="rtn.interviewTime" maxlength="10"                    
                    onchange="rtn.checkInterviewTime(true);" />
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <app:text name="<%=formName%>"
                    property="receivedTimeForDisplay"
                    styleClass="text"
                    styleId="ind.receivedTimeForDisplay" maxlength="10"                    
                    onchange="ind.checkReceivedTime(true);" />
        ...
        <tr>
            ...
            <app:text name="<%=formName%>"
                    property="interviewTime"
                    styleClass="text"
                    styleId="ind.interviewTime" maxlength="10"                    
                    onchange="ind.checkInterviewTime(true);" />
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <app:text name="<%=formName%>"
                    property="receivedTimeForDisplay"
                    styleClass="text"
                    styleId="spe.receivedTimeForDisplay" maxlength="10"                    
                    onchange="spe.checkReceivedTime(true);" />
        ...
        <tr>
            ...
            <app:text name="<%=formName%>"
                    property="interviewTime"
                    styleClass="text"
                    styleId="spe.interviewTime" maxlength="10"                    
                    onchange="spe.checkInterviewTime(true);" />
