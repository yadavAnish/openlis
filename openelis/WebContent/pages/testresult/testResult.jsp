...
<table>
    ...
    <tr>
        <td class="label">
            <bean:message key="testresult.scriptletName"/>:
        </td>
        <td>
...
<ajax:autocomplete
        source="resultValue"
        target="selectedDictionaryValue"
        baseUrl="ajaxAutocompleteXML"
        className="autocomplete"
        parameters="resultValue={resultValue},provider=TestDictionaryValueAutocompleteProvider,fieldName=dictEntry,idName=id"
