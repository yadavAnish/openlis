...
<table width="100%" border=2">
    <tr>
        ...
        <%--bugzilla 1856--%>
        <th>
            <bean:message key="test.isReferredOut"/>
        </th>
        <th>
    ...
    <logic:iterate id="tst" indexId="ctr" name="<%=formName%>" property="menuList"
        ...
        <tr>
            ...
            <td class="textcontent">
               <logic:equal name="tst" property="isReferredOut" value="true">
                   <span>Y</span>
               </logic:equal>
                <logic:equal name="tst" property="isReferredOut" value="false">
                    <span>N</span>
                </logic:equal>
            </td>
                <%--bugzilla 1856--%>
